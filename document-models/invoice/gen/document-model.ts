      ...
      modules: [
        {
          ...
          operations: [
            ...
            {
              id: "7e67fb92-b2bb-417c-8e0d-8a39c7faea66",
              name: "ADD_PAYMENT_ACCOUNT",
              description: "",
              schema:
                "input AddPaymentAccountInput {\n  paymentAccount: String!\n}",
              template: "",
              reducer: "",
              errors: [],
              examples: [],
            ...
            {
              id: "363c9856-86bf-4917-bc47-a35ae768c46e",
              name: "EDIT_PAYMENT_ACCOUNT",
              description: "",
              schema:
                "input EditPaymentAccountInput {\n  existingPaymentAccount: String!\n  newPaymentAccount: String!\n}",
              template: "",
              reducer: "",
              errors: [],
              examples: [],
            ...
            {
              id: "7c7221bf-d58d-4b4f-bfd2-024b02de6289",
