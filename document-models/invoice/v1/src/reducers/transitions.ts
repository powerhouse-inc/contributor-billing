...
import type { InvoiceTransitionsOperations } from "@powerhousedao/contributor-billing/document-models/invoice/v1";
...
const permittedTransitions: Record<Status, string[]> = {
