...
const billingTagMapping = [
  ...
  { fusion: "Professional Services", xero: "Finance Team Fees Abroad" },
  {
    ...
    xero: "Finance and Accounting Fees Switzerland",
  },
  {
    fusion: "Software Development Expense",
    xero: "Software Development Team Fees",
  },
  ...
  {
    fusion: "Fixed Asset",
    xero: "Less Accumulated Depreciation on Office Equipment",
  },
  { fusion: "Non-Current Asset", xero: "Computer Equipment" },
  {
    fusion: "Non-Current Asset",
    xero: "Less Accumulated Depreciation on Computer Equipment",
  },
